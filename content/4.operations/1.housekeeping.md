...
The standalone [`taskq scheduler`](/operations/standalone-scheduler) calls
...
Schedule firing remains part of the current `0.1.0a25` surface; its original
...
and remain part of package `0.1.0a25`.

...
| Packaged migrations | `0001`–`0043` (admission, workflows, schedules, target attestation, bounded operator projections, the per-queue flow-control plane, workflow bulk admission, …) |
| SQL contract | **0.6.12** |

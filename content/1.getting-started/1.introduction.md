...
**Latest alpha release: `0.1.0a41`.** The a40 runtime introduced the SQL kernel,
...
Release a41 leaves that runtime and SQL contract unchanged. It adds one bounded
PostgreSQL 18 dump/restore catalog-verifier allowance; existing a40 consumers
can stay on a40. See [restore verification](/operations/postgresql-18-restore-verification)
before accepting a restored database.

This documentation source tracks the published a41 release. Verify the package
index, release record, and artifact hashes before rollout. Deep contract specs and

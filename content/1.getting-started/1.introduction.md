...
::card-group
  ...
  title: SQL kernel
  ---
  Schema `taskq`, migrations `0001`–`0043`, SQL contract **0.6.7**, capability roles, and plan/apply migration plus exact verification.
  :::
...
**Alpha (`0.1.0a37`).** The package includes the SQL kernel,
...
counter-backed enqueue depth checks. Protocol revision is **1.0.18**.

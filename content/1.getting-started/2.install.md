...
Published via [GitHub Releases](https://github.com/outlabsio/outlabs-taskq/releases) (PyPI not yet). Pin the exact `0.1.0a19` wheel:

```bash
pip install https://github.com/outlabsio/outlabs-taskq/releases/download/v0.1.0a19/outlabs_taskq-0.1.0a19-py3-none-any.whl

# with extras:
pip install "outlabs-taskq[http] @ https://github.com/outlabsio/outlabs-taskq/releases/download/v0.1.0a19/outlabs_taskq-0.1.0a19-py3-none-any.whl"
pip install "outlabs-taskq[outlabs] @ https://github.com/outlabsio/outlabs-taskq/releases/download/v0.1.0a19/outlabs_taskq-0.1.0a19-py3-none-any.whl"
```
